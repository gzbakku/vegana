...
# latest features
  ...
  - comps are now lazy too.
  - lazy loader now has hooks to call functions when lazy modules are loaded and ready to use.
  - engine is optimized with vegana native comps.
  - now you can make span in dom module.
