module.exports = {
  ...
  init:async (name)=>{
    ...
    const uiLazySassBinPath = bin + "/generate/uiLazySass.scss";
    const uiLazySassToPath = this_ui_dir + "/@lazy.scss";

    if(!await io.copy(uiLazySassBinPath,uiLazySassToPath)){
      return common.error("failed-generate-lazy-sass_file");
    }
