...
function getModuleAddress(type,parents){
  ...
  if(type == 'global'){
    ...
    sassRead = baseRead + '/globals/' + parents['global'] + '/+comp.sass';
  ...
  if(type == 'page'){
    ...
    sassRead = baseRead + '/pages/' + parents['page'] + '/page.js';
    sassWrite = baseWriteSass + '/pages/' + parents['page'] + '/page.js';
  }
  ...
  if(type == 'cont'){
    ...
    sassRead = baseRead + '/pages/' + parents['page'] + '/conts/' + parents['cont'] + '/cont.js';
    sassWrite = baseWriteSass + '/pages/' + parents['page'] + '/conts/' + parents['cont'] + '/cont.js';
  }
  ...
  if(type == 'panel'){
    ...
    sassRead = baseRead + '/pages/' + parents['page'] + '/conts/' + parents['cont'] + '/panels/' + parents['panel'] + '/panel.js';
    sassWrite = baseWriteSass + '/pages/' + parents['page'] + '/conts/' + parents['cont'] + '/panels/' + parents['panel'] + '/panel.js';
  }
